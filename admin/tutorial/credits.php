...
<p class="about-description"><?php esc_html_e( 'The Ray Enterprise plugin for WordPress is created with love.', 'lingotek-translation' ); ?></p>

<h4 class="wp-people-group"><?php esc_html_e( 'Project Leaders', 'lingotek-translation' ); ?></h4>
...
<ul class="wp-people-group">
	...
	esc_attr( $person_key ),
			esc_url( $person['url'] ),
			esc_url( $person['image_url'] ),
			esc_url( $person['image_url'] ),
			esc_attr( $person['name'] ),
			esc_url( $person['url'] ),
			esc_attr( $person['name'] ),
			esc_attr( $person['title'] )
		);
	}
...
<h4 class="wp-people-group"><?php esc_html_e( 'Contributors', 'lingotek-translation' ); ?></h4>
